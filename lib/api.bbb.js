...
var getMeetingInfo = module.exports.getMeetingInfo = function(req, meetingID, callback) {
    ...
    var meetingInfoURL = _getBBBActionURL('getMeetingInfo', bbbConfig.endpoint, bbbConfig.secret, _getQueryStringParams(params));
    BBBProxy.executeBBBCall(meetingInfoURL, function(err, meetingInfo) {
        if (err) {
            ...
            return callback(null, {'returncode':'success','meetingInfo': meetingInfo});
        } else {
            return callback(null, {'returncode':'success','meetingInfo': meetingInfo});
        }
    });
...
var joinURL = module.exports.joinURL = function(req, meetingProfile, configXML, callback) {
    ...
    BBBProxy.executeBBBCall(meetingInfoURL, function(err, meetingInfo) {
        ...
        if ( meetingInfo.returncode == 'FAILED' && meetingInfo.messageKey == 'notFound' ) {
            ...
            var createMeetingURL = _getBBBActionURL('create', bbbConfig.endpoint, bbbConfig.secret, _getQueryStringParams(params));
                ...
                if( configXML != null && configXML != '' ) {
                    ...
                    BBBProxy.executeBBBCallExtended(setConfigXMLURL, null, 'post', config_xml_params, 'application/x-www-form-urlencoded', function(err, response) {
                        if (err || response.returncode == 'FAILED') {
                            var joinURL = _getBBBActionURL('join', bbbConfig.endpoint, bbbConfig.secret, _getQueryStringParams(params));
...
var getEndURL = module.exports.getEndURL = function(req, profile, callback) {
    ...
    BBBProxy.executeBBBCall(meetingInfoURL, function(err, meetingInfo) {
        ...
        if ( meetingInfo.returncode == 'FAILED' && meetingInfo.messageKey == 'notFound' ) {
            ...
            var endURL = _getBBBActionURL('end', bbbConfig.endpoint, bbbConfig.secret, _getQueryStringParams(params));
...
var getRecordingsURL = module.exports.getRecordingsURL = function(req, profile, callback) {
    ...
    // Construct and sign the URL
    var params = {'meetingID': meetingID};
    var getRecordingsURL = _getBBBActionURL('getRecordings', bbbConfig.endpoint, bbbConfig.secret, _getQueryStringParams(params));
...
var deleteRecordingsURL = module.exports.deleteRecordingsURL = function(req, recordingID, callback) {
    ...
    var deleteRecordingsURL = _getBBBActionURL('deleteRecordings', bbbConfig.endpoint, bbbConfig.secret, _getQueryStringParams(params));
...
var updateRecordingsURL = module.exports.updateRecordingsURL = function(req, recordingID, body, callback) {
    ...
    var updateRecordingsURL = _getBBBActionURL('publishRecordings', bbbConfig.endpoint, bbbConfig.secret, _getQueryStringParams(body));
...
var _getMeetingInfoURL = function(meetingID, endpoint, secret) {
    // Make sure the meeting is running
    var params = {'meetingID': meetingID};
    return _getBBBActionURL('getMeetingInfo', endpoint, secret, _getQueryStringParams(params));
};
